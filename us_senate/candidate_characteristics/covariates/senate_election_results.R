...
load("MIT_senate_data.RData") # adjust name if neccessary 
...
# Save senate election results from 1998 to 2018
saveRDS(senate_results, 'senate_results.RDS')

# Save data frame with election in which more than one Rep./Dem candidate participated
