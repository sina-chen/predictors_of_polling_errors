#-------------------------------------------------------------------------------
#
# Scrape script: Senate general election olls from 1998 to 2022
# Author: Sina Chen
...

{
  ...
  polls_raw2022 <- extract_senate(paste0(senate_wd,'/year2022/txt'))
}
...

{
  ...
  # 2022
  polls_senate2022 <- polls_raw2022 %>% 
    clean_split() %>% 
    lapply( rm_nonSenate) %>%
    convert_to_dataframe(repC = '[()]R[)]|Republican', 
                         demC = '[()]D[)]|Democratic',
...
polls_senate1998_2022 <- rbind(polls_senate1998, polls_senate2000,
...
# Save polls
saveRDS(polls_senate1998_2022, paste0(senate_wd,"/polls_senate1998_2022.RDS"))
