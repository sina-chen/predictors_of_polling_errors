data {
  ...
  vector[K-1] zero_l[L];                    // matrix of zeros for party error
  vector[K] zero_rK[R];                    // matrix of zeros for party error
...
parameters {
  ...
  // Hyperpriors  
    ...
    vector[K-1] alpha2_raw[L];
    cholesky_factor_corr[K-1] lkj_alpha2_corr; // correlation matrix of common party bias
    real<lower=0> sd_tau_alpha2;
    vector<lower=0>[K-1] tau_alpha2_sc; // untransformed common party sd    
