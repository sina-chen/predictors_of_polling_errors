...
rm_resp <- function(dt){
  ...
  rem_row2 <- which(str_detect(dt[-c(1:4),2], 'STATEWIDE') == T &
                      ...
                      str_detect(dt[-c(1:4),2], 'Among') == T &
                      str_detect(dt[-c(1:4),3], 'Among') == T |
                      str_detect(dt[-c(1:4),2], 'among') == T &
                      str_detect(dt[-c(1:4),3], 'among') == T |
                      str_detect(dt[-c(1:4),2], 'Trend') == T &
                      str_detect(dt[-c(1:4),3], 'Trend') == T |
                      str_detect(dt[-c(1:4),2], 'Without Nader') == T &
                      str_detect(dt[-c(1:4),3], 'Without Nader') == T |
                      str_detect(dt[-c(1:4),2], 'Registered') == T &
                      str_detect(dt[-c(1:4),3], 'Registered') == T |
                      str_detect(dt[-c(1:4),2], 'registered') == T &
                      str_detect(dt[-c(1:4),3], 'registered') == T|
                      str_detect(dt[-c(1:4),2], 'results') == T &
                      str_detect(dt[-c(1:4),3], 'results') == T |
                      str_detect(dt[-c(1:4),2], 'Without') == T &
                      str_detect(dt[-c(1:4),3], 'Without') == T |
                      str_detect(dt[-c(1:4),2], 'Trend') == T &
                      str_detect(dt[-c(1:4),3], '^$') == T) + 4
