...
model {
  ...
  // Vairiance model
    ...
    mu_gamma2 ~ normal(0,0.05);
    sig_gamma2 ~ normal(0,0.05) T[0,]; // half normal due to bounds
    
    mu_gamma3 ~ normal(0,0.05);
    sig_gamma3 ~ normal(0,0.05) T[0,]; // half normal due to bounds
