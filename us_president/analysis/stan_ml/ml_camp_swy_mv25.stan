...
model {
  ...
  // Mean model
    ...
    mu_alpha ~ normal(0,1);
    sig_alpha ~ normal(0,1) T[0,]; // half normal due to bounds
    
    mu_beta1 ~ normal(0,1);
    sig_beta1 ~ normal(0,1) T[0,]; // half normal due to bounds
    
    mu_beta2 ~ normal(0,1);
    sig_beta2 ~ normal(0,1) T[0,]; // half normal due to bounds
  ...
  // Vairiance model
    ...
    mu_gamma1 ~ normal(0,0.22);
    sig_gamma1 ~ normal(0,0.22) T[0,]; // half normal due to bounds

    mu_gamma2 ~ normal(0,0.22);
    sig_gamma2 ~ normal(0,0.22) T[0,]; // half normal due to bounds
    
    mu_gamma3 ~ normal(0,0.22);
    sig_gamma3 ~ normal(0,0.22) T[0,]; // half normal due to bounds
    
    mu_tau ~ normal(0,0.22);
    sig_tau ~ normal(0,0.22) T[0,]; // half normal due to bounds
